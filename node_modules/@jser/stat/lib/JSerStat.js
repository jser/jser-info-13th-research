...
exports.JSerStat = void 0;
const JSerItem_1 = require("./models/JSerItem");
const JSerPost_1 = require("./models/JSerPost");
const JSerWeek_1 = require("./models/JSerWeek");
const AlgoItem_1 = require("./algo/AlgoItem");
...
class JSerStat {
    ...
    getJSerWeeks() {
        if (this._weeks.length === 0) {
            this._weeks = this.posts.reduce((results, currentPost, index) => {
                ...
                var jserWeek = new JSerWeek_1.JSerWeek(currentPost, prevPost, this._algoItem);
    ...
    findWeekWithItem(jserItem) {
        const targetItem = new JSerItem_1.JSerItem(jserItem);
